<?php
/**
 * List of all migration-files in sorted order.
 * The files have to be stored in /module/%module-name%/database/.
 *
...
return array (
	...
	array ('file' => 'migration_provider-statuses.sql', 'comment' => ''),
);